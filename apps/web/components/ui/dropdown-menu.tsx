    ...
    <MenuPrimitive.Portal>
      ...
      >
        <MenuPrimitive.Popup
          ...
          className={cn(
            "z-50 max-h-[var(--available-height)] min-w-[12rem] origin-[var(--transform-origin)] overflow-y-auto overflow-x-hidden rounded-lg border border-border bg-popover p-1 text-body text-popover-foreground shadow-floating outline-none",
...
function DropdownMenuCheckboxItem({
  ...
  return (
    ...
    >
      <span
        className="pointer-events-none absolute right-2 flex items-center justify-center text-primary-700"
...
function DropdownMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn("ml-auto text-caption tracking-wide text-muted-foreground", className)}
      {...props}
    />
  )
}
